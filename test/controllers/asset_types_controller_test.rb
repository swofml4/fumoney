...
class AssetTypesControllerTest < ActionController::TestCase
  ...
  test "should create asset_type" do
    assert_difference('AssetType.count') do
      post :create, asset_type: { historical_average_return: @asset_type.historical_average_return, historical_std_deviation: @asset_type.historical_std_deviation, name: @asset_type.name }
    end
  ...
  test "should update asset_type" do
    patch :update, id: @asset_type, asset_type: { historical_average_return: @asset_type.historical_average_return, historical_std_deviation: @asset_type.historical_std_deviation, name: @asset_type.name }
    assert_redirected_to asset_type_path(assigns(:asset_type))
  end
